...
namespace Bovis.Service.Queries
{
    public class CieQueryService : ICieQueryService
    {
        ...
        public async Task<Response<Cie_Registros>> GetRegistros(bool? activo, string nombre_cuenta, int mes, int anio, string concepto, string empresa, int num_proyecto, string responsable, int offset, int limit)
        {
            var response = await _cieBusiness.GetRegistros(activo, nombre_cuenta, mes, anio, concepto, empresa, num_proyecto, responsable, offset, limit);
