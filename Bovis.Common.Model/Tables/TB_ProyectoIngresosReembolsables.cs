...
{
	[Table(Schema = "dbo", Name = "tb_proyecto_ingresos_reembolsables_no_reembolsables")]
	public class TB_ProyectoIngresosReembolsables
	{
		[Column("NunumProyecto"), NotNull, PrimaryKey, Identity] public int NumProyecto { get; set; }
		[Column("NukidrubroIngreso"), NotNull] public int IdRubroIngreso { get; set; }
