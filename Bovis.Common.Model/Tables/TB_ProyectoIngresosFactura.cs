...
{
	[Table(Schema = "dbo", Name = "tb_proyecto_ingresos_factura")]
	public class TB_ProyectoIngresosFactura
	{
		[Column("NukidproyectoIngresoFactura"), NotNull, PrimaryKey, Identity] public int IdProyectoIngresoFactura { get; set; }
