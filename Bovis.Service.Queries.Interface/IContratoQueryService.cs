...
namespace Bovis.Service.Queries.Interface
{
    ...
    {
        #region Templates
        Task<Response<List<TB_ContratoTemplate>>> GetTemplates(string Estatus);
        Task<Response<TB_ContratoTemplate>> GetTemplate(int IdTemplate);
        ...
        Task<Response<List<TB_ContratoEmpleado>>> GetContratosEmpleado(int IdEmpleado);
        Task<Response<TB_ContratoEmpleado>> GetContratoEmpleado(int IdContratoEmpleado);
