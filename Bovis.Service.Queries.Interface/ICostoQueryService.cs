...
namespace Bovis.Service.Queries.Interface
{
    public interface ICostoQueryService
    {
        ...
        Task<Response<List<Costo_Detalle>>> GetCostos(bool? hist, string? idEmpleado, int? idPuesto, int? idProyecto, int? idEmpresa, int? idUnidadNegocio, string? FechaIni, string? FechaFin); 
        Task<Response<Costo_Detalle>> GetCosto(int IdCosto);
