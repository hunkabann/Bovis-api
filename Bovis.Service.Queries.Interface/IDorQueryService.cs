...
namespace Bovis.Service.Queries.Interface
{
    public interface IDorQueryService : IDisposable
    {
        ...
        Task<Response<List<DorObjetivoGeneral>>> GetDorObjetivosGenerales(string nivel, string unidadNegocio, int mes);
        ...
        Task<Response<List<DorObjetivoGeneral>>> GetDorMetasProyecto(int proyecto, int nivel, int mes);
    }
}
