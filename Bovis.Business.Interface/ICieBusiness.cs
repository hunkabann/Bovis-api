...
namespace Bovis.Business.Interface
{
    public interface ICieBusiness : IDisposable
    {
        ...
        Task<Cie_Registros> GetRegistros(bool? activo, string nombre_cuenta, int mes, int anio, string concepto, string empresa, int num_proyecto, string responsable, string clasificacionPY, int offset, int limit);
