...
namespace Bovis.Business.Interface
{
    public interface IDorBusiness : IDisposable
    {
        ...
        Task<(bool Success, string Message)> AddDorObjetivo(TB_Dor_Objetivos_Desepeno objetivo);
        Task<(bool Success, string Message)> UpdDorObjetivo(TB_Dor_Objetivos_Desepeno objetivo);
