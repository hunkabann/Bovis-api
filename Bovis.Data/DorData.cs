            ...
            using (var db = new ConnectionDB(dbConfig))
            {
                res = await (from a in db.tB_Dor_Objetivos_Gral
                             ...
                             group new Dor_ObjetivosGenerales
                             {
                                 ...
                                 Enero = DateTime.Now.Month >= 1 ? a.Enero ?? 0 : 0,
                                 Febrero = DateTime.Now.Month >= 2 ? a.Febrero ?? 0 : 0,
                                 Marzo = DateTime.Now.Month >= 3 ? a.Marzo ?? 0 : 0,
                                 Abril = DateTime.Now.Month >= 4 ? a.Abril ?? 0 : 0,
                                 Mayo = DateTime.Now.Month >= 5 ? a.Mayo ?? 0 : 0,
                                 Junio = DateTime.Now.Month >= 6 ? a.Junio ?? 0 : 0,
                                 Julio = DateTime.Now.Month >= 7 ? a.Julio ?? 0 : 0,
                                 Agosto = DateTime.Now.Month >= 8 ? a.Agosto ?? 0 : 0,
                                 Septiembre = DateTime.Now.Month >= 9 ? a.Septiembre ?? 0 : 0,
                                 Octubre = DateTime.Now.Month >= 10 ? a.Octubre ?? 0 : 0,
                                 Noviembre = DateTime.Now.Month >= 11 ? a.Noviembre ?? 0 : 0,
                                 Diciembre = DateTime.Now.Month >= 12 ? a.Diciembre ?? 0 : 0,
                                 IngresoEnero = DateTime.Now.Month >= 1 ? dItem.InEnero ?? 0 : 0,
                                 IngresoFebrero = DateTime.Now.Month >= 2 ? dItem.InFebrero ?? 0 : 0,
                                 IngresoMarzo = DateTime.Now.Month >= 3 ? dItem.InMarzo ?? 0 : 0,
                                 IngresoAbril = DateTime.Now.Month >= 4 ? dItem.InAbril ?? 0 : 0,
                                 IngresoMayo = DateTime.Now.Month >= 5 ? dItem.InMayo ?? 0 : 0,
                                 IngresoJunio = DateTime.Now.Month >= 6 ? dItem.InJunio ?? 0 : 0,
                                 IngresoJulio = DateTime.Now.Month >= 7 ? dItem.InJulio ?? 0 : 0,
                                 IngresoAgosto = DateTime.Now.Month >= 8 ? dItem.InAgosto ?? 0 : 0,
                                 IngresoSeptiembre = DateTime.Now.Month >= 9 ? dItem.InSeptiembre ?? 0 : 0,
                                 IngresoOctubre = DateTime.Now.Month >= 10 ? dItem.InOctubre ?? 0 : 0,
                                 IngresoNoviembre = DateTime.Now.Month >= 11 ? dItem.InNoviembre ?? 0 : 0,
                                 IngresoDiciembre = DateTime.Now.Month >= 12 ? dItem.InDiciembre ?? 0 : 0,
                                 GastoEnero = DateTime.Now.Month >= 1 ? dItem.OutEnero ?? 0 : 0,
                                 GastoFebrero = DateTime.Now.Month >= 2 ? dItem.OutFebrero ?? 0 : 0,
                                 GastoMarzo = DateTime.Now.Month >= 3 ? dItem.OutMarzo ?? 0 : 0,
                                 GastoAbril = DateTime.Now.Month >= 4 ? dItem.OutAbril ?? 0 : 0,
                                 GastoMayo = DateTime.Now.Month >= 5 ? dItem.OutMayo ?? 0 : 0,
                                 GastoJunio = DateTime.Now.Month >= 6 ? dItem.OutJunio ?? 0 : 0,
                                 GastoJulio = DateTime.Now.Month >= 7 ? dItem.OutJulio ?? 0 : 0,
                                 GastoAgosto = DateTime.Now.Month >= 8 ? dItem.OutAgosto ?? 0 : 0,
                                 GastoSeptiembre = DateTime.Now.Month >= 9 ? dItem.OutSeptiembre ?? 0 : 0,
                                 GastoOctubre = DateTime.Now.Month >= 10 ? dItem.OutOctubre ?? 0 : 0,
                                 GastoNoviembre = DateTime.Now.Month >= 11 ? dItem.OutNoviembre ?? 0 : 0,
                                 GastoDiciembre = DateTime.Now.Month >= 12 ? dItem.OutDiciembre ?? 0 : 0
            ...
            {                
                res = await (from a in db.tB_Dor_Meta_Proyectos
                             ...
                             group new Dor_ObjetivosGenerales
                             {
                                 ...
                                 Noviembre = DateTime.Now.Month >= 11 ? a.Noviembre ?? 0 : 0,
                                 Diciembre = DateTime.Now.Month >= 12 ? a.Diciembre ?? 0 : 0,                                 
                                 ProyectadoEnero = DateTime.Now.Month >= 1 ? a.ProyectadoEnero ?? 0 : 0,
                                 ProyectadoFebrero = DateTime.Now.Month >= 2 ? a.ProyectadoFebrero ?? 0 : 0,
                                 ProyectadoMarzo = DateTime.Now.Month >= 3 ? a.ProyectadoMarzo ?? 0 : 0,
                                 ProyectadoAbril = DateTime.Now.Month >= 4 ? a.ProyectadoAbril ?? 0 : 0,
                                 ProyectadoMayo = DateTime.Now.Month >= 5 ? a.ProyectadoMayo ?? 0 : 0,
                                 ProyectadoJunio = DateTime.Now.Month >= 6 ? a.ProyectadoJunio ?? 0 : 0,
                                 ProyectadoJulio = DateTime.Now.Month >= 7 ? a.ProyectadoJulio ?? 0 : 0,
                                 ProyectadoAgosto = DateTime.Now.Month >= 8 ? a.ProyectadoAgosto ?? 0 : 0,
                                 ProyectadoSeptiembre = DateTime.Now.Month >= 9 ? a.ProyectadoSeptiembre ?? 0 : 0,
                                 ProyectadoOctubre = DateTime.Now.Month >= 10 ? a.ProyectadoOctubre ?? 0 : 0,
                                 ProyectadoNoviembre = DateTime.Now.Month >= 11 ? a.ProyectadoNoviembre ?? 0 : 0,
                                 ProyectadoDiciembre = DateTime.Now.Month >= 12 ? a.ProyectadoDiciembre ?? 0 : 0
                             } by new { a.Descripcion, a.Concepto } into g
                             select new Dor_ObjetivosGenerales
                             {
                                 Id = g.First().Id,
