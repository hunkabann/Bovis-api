            ...
            using (var db = new ConnectionDB(dbConfig))
            {
                ...
                var res_facturas = await (from a in db.tB_ProyectoFacturas
                                          ...
                                          select new Cie_Detalle
                                          {
                                              ...
                                              Haber = (a.FechaCancelacion != null) ? null : (a.IdMoneda == "MXN" ? a.Importe : a.Importe * a.TipoCambio),
                                              Movimiento = (a.IdMoneda == "MXN" ? a.Importe : a.Importe * a.TipoCambio) * -1,
                ...
                var res_notas = await (from notas in db.tB_ProyectoFacturasNotaCredito
                                       ...
                                       select new Cie_Detalle
                                       {
                                           ...
                                           Haber = notas.FechaCancelacion == null ? null : (notas.IdMoneda == "MXN" ? notas.Importe : notas.Importe * notas.TipoCambio),
                                           Movimiento = (notas.IdMoneda == "MXN" ? notas.Importe : notas.Importe * notas.TipoCambio),
                ...
                var res_cobranzas = await (from cobr in db.tB_ProyectoFacturasCobranza
                                           ...
                                           select new Cie_Detalle
                                           {
                                               ...
                                               Haber = cobr.FechaCancelacion != null ? null : (cobr.IdMonedaP == "MXN" ? cobr.ImportePagado : cobr.ImportePagado * cobr.TipoCambioP),
                                               Movimiento = (cobr.IdMonedaP == "MXN" ? cobr.ImportePagado : cobr.ImportePagado * cobr.TipoCambioP) * -1,
                                               Empresa = emprItem != null ? emprItem.Empresa : string.Empty,
                                               NumProyecto = factsItem != null ? factsItem.NumProyecto : 0,
