...
public class MappingsProfile : Profile
{
    public MappingsProfile()
    {
        ...
        CreateMap<Empleado_Detalle, Detalle_Empleado>()
            ...
            .ForMember(c => c.nudescuento_pension, dto => dto.MapFrom(src => src.nudescuento_pension))
        ...
        CreateMap<TB_Empleado, Empleado>()
            ...
            .ForMember(c => c.boactivo, dto => dto.MapFrom(src => src.Activo))
            .ForMember(c => c.chporcentaje_pension, dto => dto.MapFrom(src => src.ChPorcentajePension))
            .ForMember(c => c.nudescuento_pension, dto => dto.MapFrom(src => src.DescuentoPension))
