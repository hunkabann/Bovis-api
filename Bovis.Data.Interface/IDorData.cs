...
public interface IDorData : IDisposable
{
    ...
    Task<(bool Success, string Message)> AddObjetivo(TB_DorObjetivosDesepeno objetivo);
    Task<(bool Success, string Message)> UpdObjetivo(TB_DorObjetivosDesepeno objetivo);
