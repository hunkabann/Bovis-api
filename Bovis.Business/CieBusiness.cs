...
namespace Bovis.Business
{
    public class CieBusiness : ICieBusiness
    {
        ...
        public Task<Cie_Registros> GetRegistros(bool? activo, string nombre_cuenta, int mes, int anio, string concepto, string empresa, int num_proyecto, string responsable, string clasificacionPY, int offset, int limit) => _cieData.GetRegistros(activo, nombre_cuenta, mes, anio, concepto, empresa, num_proyecto, responsable, clasificacionPY, offset, limit);
